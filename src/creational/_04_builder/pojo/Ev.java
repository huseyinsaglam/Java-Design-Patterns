package creational._04_builder.pojo;
...
public class Ev {
    ...
    public Ev(String il, String ilce, String mahalle, int binaYili, int balkonSayisi, int odaSayisi,
              int banyoSayisi, int tuvaletSayisi, boolean isDublex, boolean isEsyali, boolean hasOtopark,
              boolean hasCocukParki, boolean hasKlima, boolean hasHavuz) {
        this.il = il;
        this.ilce = ilce;
